...
public class ManagerFoodListService implements FoodService {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		request.setAttribute("foodKind", food_kindName);
		request.setAttribute("foodCount", count);
